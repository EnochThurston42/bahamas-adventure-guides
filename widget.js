...
(function() {
  ...
  style.textContent = [
    ...
    '.bagh-form button { background:linear-gradient(135deg,#075f74,#0a8aa8);color:#fff;border:none;border-radius:12px;padding:14px 20px;margin-top:6px;cursor:pointer;font-weight:600;font-size:0.98rem;box-shadow:0 2px 8px rgba(7,95,116,0.25);transition:all 0.2s;min-height:48px;letter-spacing:0.01em; }',
    '.bagh-form button:hover { transform:translateY(-1px);box-shadow:0 4px 14px rgba(7,95,116,0.4); }',
