...
(function() {
  ...
  style.textContent = [
    ...
    '#bagh-chat-panel { position:fixed;bottom:104px;right:24px;z-index:9998;width:360px;height:480px;max-height:calc(100vh - 120px);background:#fff;border-radius:20px;box-shadow:0 20px 60px rgba(0,0,0,0.15);display:none;flex-direction:column;overflow:hidden;animation:bagh-up 0.3s cubic-bezier(0.4,0,0.2,1); }',
    '#bagh-chat-panel.open { display:flex; }',
    '.bagh-form { padding:20px 20px 24px;display:flex;flex-direction:column;gap:10px;flex:1;justify-content:flex-start;overflow-y:auto;scrollbar-width:thin;scrollbar-color:#0a8aa8 #e8e4de; }',
    ...
    '.bagh-form button { background:linear-gradient(135deg,#075f74,#0a8aa8);color:#fff;border:none;border-radius:10px;padding:12px 0;cursor:pointer;font-weight:600;font-size:0.9rem;box-shadow:0 4px 12px rgba(7,95,116,0.3);transition:all 0.2s;min-height:42px;width:100%;display:flex;align-items:center;justify-content:center;text-align:center;letter-spacing:0.02em;margin-top:4px; }',
