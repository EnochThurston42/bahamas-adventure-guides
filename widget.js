...
(function() {
  ...
  style.textContent = [
    ...
    '.bagh-msgs { flex:1;min-height:0;height:0;overflow-y:scroll;padding:20px;display:flex;flex-direction:column;gap:12px;background:#f9f8f5;scrollbar-width:thin;scrollbar-color:#0a8aa8 #f9f8f5; }',
