...
(function() {
  ...
  style.textContent = [
    ...
    '.bagh-msgs { flex:1 1 0%;min-height:0;overflow-y:scroll;padding:20px;display:flex;flex-direction:column;gap:12px;background:#f9f8f5;scrollbar-width:thin;scrollbar-color:#0a8aa8 #e8e4de; }',
    ...
    '#bagh-chat-panel { position:fixed;bottom:104px;right:24px;z-index:9998;width:360px;max-height:calc(100vh - 120px);background:#fff;border-radius:20px;box-shadow:0 20px 60px rgba(0,0,0,0.15);display:none;flex-direction:column;overflow:hidden;animation:bagh-up 0.3s cubic-bezier(0.4,0,0.2,1); }',
    '#bagh-chat-panel.open { display:flex; }',
    '#bagh-chat-panel .bagh-hdr { flex-shrink:0; }',
    '#bagh-chat-panel .bagh-form { flex:1;min-height:0;overflow-y:auto;padding:20px 20px 24px;display:flex;flex-direction:column;gap:10px;scrollbar-width:thin;scrollbar-color:#0a8aa8 #e8e4de; }',
    '.bagh-form h3 { margin:0;font-size:1.05rem;color:#0d2538;font-weight:700;letter-spacing:-0.01em; }',
    '.bagh-form p { margin:0 0 10px;color:#666;font-size:0.8rem;line-height:1.4; }',
    '.bagh-form input { padding:10px 14px;border:1.5px solid #e0ddd5;border-radius:10px;font-size:0.88rem;outline:none;background:#fbf8f2;color:#1a1a1a;transition:border-color 0.2s,background 0.2s,box-shadow 0.2s;width:100%;font-family:inherit; }',
    '.bagh-form input::placeholder { color:#9ca3af;opacity:1;font-weight:400; }',
    '.bagh-form input:hover { border-color:#b8a78a; }',
    '.bagh-form input:focus { border-color:#0a8aa8;background:#fff;box-shadow:0 0 0 3px rgba(10,138,168,0.12); }',
    '.bagh-form button { background:linear-gradient(135deg,#075f74,#0a8aa8);color:#fff;border:none;border-radius:10px;padding:12px 0;cursor:pointer;font-weight:600;font-size:0.9rem;box-shadow:0 4px 12px rgba(7,95,116,0.3);transition:all 0.2s;min-height:42px;width:100%;display:flex;align-items:center;justify-content:center;text-align:center;letter-spacing:0.02em;margin-top:auto; }',
    '.bagh-form button:hover { transform:translateY(-1px);box-shadow:0 6px 16px rgba(7,95,116,0.4);background:linear-gradient(135deg,#0a8aa8,#0d2538); }',
    '.bagh-form button:active { transform:translateY(0); }',
    '.bagh-form button:disabled { background:#9ca3af;cursor:not-allowed;transform:none;box-shadow:none; }',
  ...
  chat.innerHTML = [
    ...
    '<div id="bagh-form" class="bagh-form"><h3>Start planning your trip</h3><p>We need your details to help plan the perfect experience.</p><input type="text" id="bagh-first" placeholder="First name" maxlength="50" autocomplete="off" data-form-type="other"><input type="text" id="bagh-last" placeholder="Last name" maxlength="50" autocomplete="off" data-form-type="other"><input type="email" id="bagh-email" placeholder="Email" maxlength="200" autocomplete="off" data-form-type="other"><input type="tel" id="bagh-phone" placeholder="Phone" maxlength="20" autocomplete="off" data-form-type="other"><input type="number" id="bagh-age" placeholder="Age" min="1" max="150" autocomplete="off" data-form-type="other"><button id="bagh-start">Start Chat</button></div>',
    '<div id="bagh-loading" class="bagh-loading" style="display:none">Connecting...</div>',
    '<div id="bagh-chat-view" style="display:none;flex-direction:column;flex:1;min-height:0;height:0"><div class="bagh-msgs" id="bagh-msgs"></div><div class="bagh-input"><button class="bagh-ico-btn" id="bagh-file-btn" title="Attach file">File</button><textarea id="bagh-input" placeholder="Type..." rows="1"></textarea><button class="bagh-ico-btn" id="bagh-loc-btn" title="Share location">Map</button><button id="bagh-send">Send</button></div></div>',
    '</div>'
  ].join('');
