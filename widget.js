...
(function() {
  ...
  style.textContent = [
    ...
    '.bagh-form { padding:24px 24px 32px;display:flex;flex-direction:column;gap:12px;flex:1;justify-content:flex-start;overflow-y:auto;scrollbar-width:thin;scrollbar-color:#0a8aa8 #e8e4de; }',
    ...
    '.bagh-form button { background:linear-gradient(135deg,#075f74,#0a8aa8);color:#fff;border:none;border-radius:12px;padding:14px 0;cursor:pointer;font-weight:600;font-size:0.98rem;box-shadow:0 4px 12px rgba(7,95,116,0.3);transition:all 0.2s;min-height:48px;width:100%;display:flex;align-items:center;justify-content:center;text-align:center;letter-spacing:0.02em; }',
